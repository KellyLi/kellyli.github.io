...
body = new Layer
	...
	width: 550
	midX: 320
body.html = "Tap to choose a color. Press and hold to light up the screen for your driver."
body.style =
	...
	'text-align':'center'
	'line-height':'1.4em'
body.states.add('shown',opacity:1)
